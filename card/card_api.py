...
from database.cardservice import get_exact_card_db,\
    get_exact_user_cards_db, add_card_db, delete_exact_card_db,\
...
async def get_card_info(user_id: int, card_id: int):
